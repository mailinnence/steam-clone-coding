        ...
        <tr>
            <td>
                <div class="왼쪽배치">
                    ...
                    <form action= "<?php echo htmlspecialchars("loss_myid.php");?>" method="POST">
                        <h2  style="color: white;">패쓰워드 찾기<br>가입 당시 이용한 이메일이나 전화번호를<br> 적어주세요</h2>
                        <div style="color: white;">email or phone_number:<br /></div>
                        <input type="text" name="username"><br />
                        <br />
                        <input type="submit" value="Login" name="Login" >
                        <?php echo tokenField();?>
                        <a href= "<?php echo htmlspecialchars("loss_myid2.php");?>">아이디 분실시 클릭</a>
                    </form>
                    <br /><br />
                </div>
